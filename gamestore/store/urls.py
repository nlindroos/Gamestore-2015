...
urlpatterns = patterns('',
    ...
    url(r'^profile/password/?$', password_view, name="change_password"),
    ...
    url(r'^google_login/?$', google_login_view, name="google_login"),
    ...
    url(r'^dev/help/?$', dev_help_view, name='dev_help'),
