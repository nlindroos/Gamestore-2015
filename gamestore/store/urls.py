...
urlpatterns = patterns('',
    ...
    url(r'^loggedin/?$', auth_view),
    url(r'^logout/?$', logout_view), #'django.contrib.auth.views.login', {'template_name': 'store/login.html'}),
    ...
    url(r'^mygames/(\w+)/scores$', gamescore_ajax_view),
